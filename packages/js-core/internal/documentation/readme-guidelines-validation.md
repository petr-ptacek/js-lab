...
**Rationale**: Validation utilities are typically simple type guards or checkers. Complex examples can confuse
developers who just want to understand basic usage.
